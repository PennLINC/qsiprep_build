...
RUN bash -c \
    'mkdir /atlas \
    && cd  /atlas \
    && wget -nv https://upenn.box.com/shared/static/tr5ldcrd9d4pqbs5brgit1k0iduqilgr.xz \
    && tar xvfJm tr5ldcrd9d4pqbs5brgit1k0iduqilgr.xz \
    && rm tr5ldcrd9d4pqbs5brgit1k0iduqilgr.xz'
